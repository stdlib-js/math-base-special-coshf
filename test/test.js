...
tape( 'the function returns `+infinity` if provided a value greater than `MAXLOGF`', function test( t ) {
	var v;
	var i;
	var y;
...
tape( 'the function returns `+infinity` if provided a value less than `-MAXLOGF`', function test( t ) {
	var y;
	var v;
	var i;
